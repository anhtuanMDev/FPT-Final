...
CREATE TABLE Reviews (
    Id VARCHAR(20) PRIMARY KEY, Point INTEGER, UserID VARCHAR(20) NOT NULL, TargetID VARCHAR(20) NOT NULL, Comment VARCHAR(300), Status VARCHAR(20),  CreateAt DATETIME, UpdateAt DATETIME, FOREIGN KEY (UserID) REFERENCES Users (Id)
);
...
INSERT INTO
    Foods (
        Id, Name, Description, CreateAt, TimeMade, FeatureItem, Price, Status, Discount, RestaurantID
    )
VALUES (
