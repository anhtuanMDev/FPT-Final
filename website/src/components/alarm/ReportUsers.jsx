...
const ReportUsers = (prop) => {
    ...
    const getReportUsers = async () => {
        ...
        console.log("errorPerPage", errorPerPage)
    ...
    const banUser = async (reportID, name, adminID, status, targetID) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    icon: 'success',
                    text: `Người dùng ${name} đã bị cấm`
                })
            }
        });
    }
                ...
                <ul className="sidebar-nav" id="sidebar-nav">
                    ...
                    <li className="nav-item">
                        ...
                        <ul id="tables-nav" className="nav-content collapse show" data-bs-parent="#sidebar-nav">
                            ...
                            <li>
                                <a onClick={() => changePage('/reports/report-users')} className='active'>
                                    <ReactSVG
                                        src={dot}
                                        className='nav-link-subicon dot'
                                    />
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td className="fw-bold" style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                                                    ...
                                                                                    <button type="button" className='btn btn-danger' style={{ marginLeft: 10 }}
                                                                                        onClick={() => banUser(item.Id, item.TargetName, adminID, "Banned", item.TargetID)}
                                                                                    >Cấm</button>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
