...
const Foods = () => {
    ...
    const loadBanFood = async () => {
        const response = await AxiosInstance().get('/get-banned-food.php');
        const foods = response.data;
        ...
        dispatchData({ type: "GET_BAN_FOOD", payload: list });
                                            ...
                                            <div className="tab-content pt-2">
                                                ...
                                                <div className="tab-pane fade pt-3" id="profile-change-password">
                                                    ...
                                                    >
                                                        ...
                                                        <tbody>
                                                            {
                                                                data.banFood.length > 0 ? data.banFood.map((res) => {
                                                                    return (
                                                                        <tr>
                                                                            ...
                                                                            <td>{res.data.Name}</td>
                                                                            <td>{res.data.ResName}</td>
                                                                            <td><a href="#" className="text-primary fw-bold">{res.data.Price}</a></td>
                                                                            <td>
