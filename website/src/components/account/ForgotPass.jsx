                                            ...
                                            <form className="row g-3 needs-validation">
                                                ...
                                                <div className="col-12">
                                                    ...
                                                    <div className="input-group has-validation">
                                                        ...
                                                        <input type="text" name="username" className="form-control" id="yourUsername" required defaultValue={'OliviaRamirez@gmail.com'} />
                                                ...
                                                <div className="col-12">
                                                    ...
                                                    <textarea type="text" name="password" className="form-control" id="yourPassword" required defaultValue={'123456'} maxLength={200} minLength={5} style={{ height: 200, width: 400 }} />
